...
let get_ekikan_kyori3 e_f e_t t = assoc e_t (Tree.search t e_f)
let ekikan_tree = let t1 = Tree.insert Tree.empty "代々木公園" [("明治神宮前", 1.2);("代々木上原", 1.0)] in
                  let t2 = Tree.insert t1 "代々木上原" [("代々木公園", 1.0)] in
                  Tree.insert t2 "明治神宮前" [("代々木公園", 1.2)]
