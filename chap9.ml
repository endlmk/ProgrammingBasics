...
let rec even lst = match lst with
    [] -> []
  | fst :: rest -> if fst mod 2 = 0 then fst :: even rest else even rest
...
let rec concat lst = match lst with 
    [] -> ""
  | fst :: rest -> fst ^ concat rest

let%test _ = concat ["春";"夏";"秋";"冬"] = "春夏秋冬"
let%test _ = concat ["1";"2";"3"] = "123"
let%test _ = concat ["春休み";"夏休み";"秋";"冬休み"] = "春休み夏休み秋冬休み"

(* 目的: person_tのリストから血液型がAの人の数を返す *)
(* count_ketsueki_A: person_t list -> int  *)
let rec count_ketsueki_A lst = match lst with
    [] -> 0
  | {name=_;hight=_;weight=_;birth_month=_;birth_day=_;blood=b;} :: rest 
    -> if b = "A" then 1 + count_ketsueki_A rest 
                   else count_ketsueki_A rest

let%test _ = count_ketsueki_A [
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="A"};
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="B"};
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="O"};
    ] = 1
let%test _ = count_ketsueki_A [
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="AB"};
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="B"};
    {name="A";hight=123.;weight=45.;birth_month=6;birth_day=12;blood="O"};
    ] = 0
let%test _ = count_ketsueki_A [
